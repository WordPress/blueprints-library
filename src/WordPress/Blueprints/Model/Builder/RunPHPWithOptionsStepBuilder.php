...
use WordPress\Blueprints\Model\DataClass\RunPHPWithOptionsStep;
use Swaggest\JsonSchema\Structure\ClassStructureContract;


/**
 * Built from #/definitions/RunPHPWithOptionsStep
 */
class RunPHPWithOptionsStepBuilder extends RunPHPWithOptionsStep implements ClassStructureContract
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->step->const = "runPHPWithOptions";
        $properties->options = PHPRunOptionsBuilder::schema();
        ...
        $ownerSchema->setFromRef('#/definitions/RunPHPWithOptionsStep');
    }
    ...
    /**
     * @param PHPRunOptionsBuilder $options
     * @return $this
     * @codeCoverageIgnoreStart
     */
    public function setOptions(PHPRunOptionsBuilder $options)
    {
    ...
    {
        $dataObject = new RunPHPWithOptionsStep();
