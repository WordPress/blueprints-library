...
/**
 * Built from #/definitions/RmStep
 */
class RmStepBuilder extends RmStep implements ClassStructureContract
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->setFromRef('#/definitions/RmStep');
    }
