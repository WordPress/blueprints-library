...
use WordPress\Blueprints\Model\DataClass\CorePluginResource;
 ...
 */
class CorePluginResourceBuilder extends CorePluginResource implements ClassStructureContract
{
    ...
    {
        $dataObject = new CorePluginResource();
