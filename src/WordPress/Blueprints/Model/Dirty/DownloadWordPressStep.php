 ...
 */
class DownloadWordPressStep extends ClassStructure implements ClassStructureContract
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->wordPressZip->anyOf[1] = FilesystemResource::schema();
        $properties->wordPressZip->anyOf[2] = InlineResource::schema();
        $properties->wordPressZip->anyOf[3] = CoreThemeResource::schema();
        $properties->wordPressZip->anyOf[4] = CorePluginResource::schema();
        $properties->wordPressZip->anyOf[5] = UrlResource::schema();
    ...
    function normalize()
    {
        return new \WordPress\Blueprints\Model\InternalValidated\ValidDownloadWordPressStep(
        $this->wordPressZip,
        $this->progress,
