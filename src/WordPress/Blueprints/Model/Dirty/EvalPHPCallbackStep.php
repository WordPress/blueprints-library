 ...
 */
class EvalPHPCallbackStep extends ClassStructure implements ClassStructureContract
{
    ...
    function normalize()
    {
        return new \WordPress\Blueprints\Model\InternalValidated\ValidEvalPHPCallbackStep(
        $this->callback,
        $this->progress,
