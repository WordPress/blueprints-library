 ...
 */
class SetSiteOptionsStep extends ClassStructure implements ClassStructureContract
{
    ...
    function normalize()
    {
        return new \WordPress\Blueprints\Model\InternalValidated\ValidSetSiteOptionsStep(
        $this->options,
        $this->progress,
