 ...
 */
class DefineWpConfigConstsStep extends ClassStructure implements ClassStructureContract
{
    ...
    function normalize()
    {
        return new \WordPress\Blueprints\Model\InternalValidated\ValidDefineWpConfigConstsStep(
        $this->consts,
        $this->progress,
