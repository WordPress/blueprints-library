 ...
 */
class ActivateThemeStep extends ClassStructure implements ClassStructureContract
{
    ...
    function normalize()
    {
        return new \WordPress\Blueprints\Model\InternalValidated\ValidActivateThemeStep(
        $this->slug,
        $this->progress,
