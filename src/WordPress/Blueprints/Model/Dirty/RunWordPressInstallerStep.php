 ...
 */
class RunWordPressInstallerStep extends ClassStructure implements ClassStructureContract
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->options = WordPressInstallationOptions::schema();
    ...
    function normalize()
    {
        return new \WordPress\Blueprints\Model\InternalValidated\ValidRunWordPressInstallerStep(
        $this->options,
        $this->progress,
