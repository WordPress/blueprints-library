...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DefineWpConfigConstsStepNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'WordPress\\Blueprints\\Generated\\Model\\DefineWpConfigConstsStep';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return $data instanceof \WordPress\Blueprints\Generated\Model\DefineWpConfigConstsStep;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \WordPress\Blueprints\Generated\Model\DefineWpConfigConstsStep();
            if (!($context['skip_validation'] ?? false)) {
                $this->validate($data, new \WordPress\Blueprints\Generated\Validator\DefineWpConfigConstsStepConstraint());
            }
            ...
            if (\array_key_exists('consts', $data)) {
                $values = new \ArrayObject([], \ArrayObject::ARRAY_AS_PROPS);
                foreach ($data['consts'] as $key => $value) {
                    $values[$key] = $value;
                }
                $object->setConsts($values);
            }
            return $object;
        }
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            $values = [];
            foreach ($object->getConsts() as $key => $value) {
                $values[$key] = $value;
            }
            $data['consts'] = $values;
            if (!($context['skip_validation'] ?? false)) {
        ...
        {
            return ['WordPress\\Blueprints\\Generated\\Model\\DefineWpConfigConstsStep' => false];
        }
    }
} else {
    class DefineWpConfigConstsStepNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
