...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RunWordPressInstallerStepNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'WordPress\\Blueprints\\Generated\\Model\\RunWordPressInstallerStep';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return $data instanceof \WordPress\Blueprints\Generated\Model\RunWordPressInstallerStep;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \WordPress\Blueprints\Generated\Model\RunWordPressInstallerStep();
            if (!($context['skip_validation'] ?? false)) {
                $this->validate($data, new \WordPress\Blueprints\Generated\Validator\RunWordPressInstallerStepConstraint());
            }
            ...
            if (\array_key_exists('options', $data)) {
                $object->setOptions($this->denormalizer->denormalize($data['options'], 'WordPress\\Blueprints\\Generated\\Model\\WordPressInstallationOptions', 'json', $context));
            }
            return $object;
        }
        ...
        {
            return ['WordPress\\Blueprints\\Generated\\Model\\RunWordPressInstallerStep' => false];
        }
    }
} else {
    class RunWordPressInstallerStepNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
