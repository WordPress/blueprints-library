...
(0,v.__)("Install %s"),t.title))}const Ae=({originalBlock:e,...t})=>{const{originalName:l,originalUndelimitedContent:n,clientId:o}=t.attributes,{replaceBlock:a}=(0,i.useDispatch)(p.store),s=!!n,u=(0,i.useSelect)((e=>{const{canInsertBlockType:t,getBlockRootClientId:l}=e(p.store);return t("core/html",l(o))}),[o]);let m=(0,v.sprintf)(/* translators: %s: block name */
(0,v.__)("Your site doesn’t include support for the %s block. You can try installing the block or remove it entirely."),e.title||l);const k=[(0,r.createElement)(Ce,{key:"install",block:e,attributes:t.attributes,clientId:t.clientId})];return s&&u&&(m=(0,v.sprintf)(/* translators: %s: block name */
