 ...
 * @return array
 */
function gutenberg_build_navigation_link_block_variations() {
...
function gutenberg_register_block_core_navigation_link() {
	register_block_type_from_metadata(
		...
		array(
			...
			'variation_callback' => 'gutenberg_build_navigation_link_block_variations',
		)
	);
}
...
add_action( 'registered_post_type', 'gutenberg_block_core_navigation_link_register_post_type_variation', 10, 2 );
add_action( 'registered_taxonomy', 'gutenberg_block_core_navigation_link_register_taxonomy_variation', 10, 3 );
// Handle unregistering of post types and taxonomies and remove the variations.
add_action( 'unregistered_post_type', 'gutenberg_block_core_navigation_link_unregister_post_type_variation' );
add_action( 'unregistered_taxonomy', 'gutenberg_block_core_navigation_link_unregister_taxonomy_variation' );
