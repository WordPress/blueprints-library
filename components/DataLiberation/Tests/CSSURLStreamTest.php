...
class CSSURLStreamTest extends TestCase {
	...
	public static function stylesheets() {
		return array(
			...
			'bad string consumes import position' => array( "@import \"https://old.example/bad\n" . '"https://old.example/text";@import/**/"https://old.example/theme.css";', "@import \"https://old.example/bad\n" . '"https://old.example/text";@import/**/"http://new.example/local/theme.css";' ),
			'URL position does not carry into text or a bad URL' => array( 'a{src:url(https://old.example/a);content:"https://old.example/text";src:url(https://old.example/bad(image),url(https://old.example/b)}', 'a{src:url(http://new.example/local/a);content:"https://old.example/text";src:url(https://old.example/bad(image),url(http://new.example/local/b)}' ),
